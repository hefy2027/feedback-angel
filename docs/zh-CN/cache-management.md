...
由于本项目使用 `uvx` 执行，每次运行都会在系统中创建 cache 文档。随着时间推移，这些 cache 可能会占用大量磁盘空间。
...
### 问题：清理时出现「文档正由另一个进程使用」错误

**原因**：有 MCP 服务器或其他 uvx 进程正在运行
...
如果遇到清理问题，请：
1. 查看本文档的故障排除部分
2. 在 [GitHub Issues](https://github.com/hefy2027/feedback-angel/issues) 报告问题
3. 提供错误信息和系统信息
