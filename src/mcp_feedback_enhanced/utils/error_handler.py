...
注意：此模块不会影响 JSON RPC 通信，所有错误处理都在应用层进行。
"""
...
class ErrorHandler:
    ...
    _ERROR_SOLUTIONS = {
        ErrorType.NETWORK: {
            "zh-TW": ["检查网络连接是否正常", "确认防火墙设置", "尝试重新启动应用进程"],
            "zh-CN": ["检查网络连接是否正常", "确认防火墙设置", "尝试重新启动应用进程"],
            "en": [
        ...
        ErrorType.FILE_IO: {
            "zh-TW": ["检查文档是否存在", "确认文档权限", "检查磁盘空间是否足够"],
            "zh-CN": ["检查文档是否存在", "确认文档权限", "检查磁盘空间是否足够"],
            "en": [
        ...
        ErrorType.PERMISSION: {
            "zh-TW": ["以管理员身份运行", "检查文档/目录权限", "联系系统管理员"],
            "zh-CN": ["以管理员身份运行", "检查文档/目录权限", "联系系统管理员"],
            "en": [
        ...
        if context:
            ...
            if context.get("file_path"):
                if language == "en":
                    ...
                    parts.append(f"文档：{context['file_path']}")
