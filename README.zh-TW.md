...
**分支版本：** [Minidoracat](https://github.com/Minidoracat) | [hefy2027](https://github.com/hefy2027)
...
- **系統提示詞**（v2.6.9）：支援設定全域系統提示詞，每次提交回饋時自動疊加，可在設定中啟用/停用
- **自動定時提交**：1-86400 秒彈性計時器，支援暫停、恢復、取消，新增暫停/開始按鈕控制
- **多會話並發回饋**（v2.6.9）：支援多個 AI Agent 同時等待回饋，待回覆列表面板、快速切換、前端輪詢+WebSocket 雙通道同步
...
注意在任務完成前根據feedback-angel工具的要求進行工具調用
```
...
```bash
# 版本查詢
uvx feedback-angel@latest version       # 檢查版本
...
# 指定語言測試
MCP_LANGUAGE=en uvx feedback-angel@latest test --web    # 強制使用英文介面
MCP_LANGUAGE=zh-TW uvx feedback-angel@latest test --web  # 強制使用繁體中文
MCP_LANGUAGE=zh-CN uvx feedback-angel@latest test --web  # 強制使用簡體中文
```
...
**Q: 中文字符亂碼**
A: 已在 v2.0.3 修復。更新到最新版本：`uvx feedback-angel@latest`
...
- 🎯 自動聚焦輸入框功能 ([PR #39](https://github.com/hefy2027/feedback-angel/pull/39))

**leo108** - [GitHub @leo108](https://github.com/leo108)
- 🌐 SSH 遠端開發支援 (`MCP_WEB_HOST` 環境變數) ([PR #113](https://github.com/hefy2027/feedback-angel/pull/113))

**Alsan** - [GitHub @Alsan](https://github.com/Alsan)
- 🍎 macOS PyO3 編譯配置支援 ([PR #93](https://github.com/hefy2027/feedback-angel/pull/93))

**fireinice** - [GitHub @fireinice](https://github.com/fireinice)
- 📝 工具文檔優化 (LLM 指令移至 docstring) ([PR #105](https://github.com/hefy2027/feedback-angel/pull/105))
